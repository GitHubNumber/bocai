	...
	<div class="blogs_main">
		...
		<div class="mood_box">
                        ...
                        <li class="logli3">
                           <table width="965" border="0" >
                               ...
                               <tr>
                                  ...
                                  <td width="688">
                                        <div class="person_leaveword5"><span><a>编辑</a>|<a>删除</a></span><a href="#">CrazyMango-->${l.user_id}</a> 2012-08-12 12:10</div>
				...
				<div class="fenye">
					...
					<a
						href="/Mango_BBS/blogs/mood!getFenYe.action?pageNum=${pageNum +1}">下一页&gt;&gt;</a>
				</div>
			</div>
		</div>
